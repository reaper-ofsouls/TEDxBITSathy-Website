...
var color2 = [255 / 255, 82 / 255, 82 / 255],
    color1 = [223 / 255, 0 / 255, 0 / 255];

    color1 = [Math.random(), Math.random(), Math.random()]

// var color1 = [198/255, 40/255, 20/255];
...
function init () {
    ...
    */
    ...
    // color1 = [Math.floor(Math.random() * 100) / 255, Math.floor(Math.random() * 100) / 255, Math.floor(Math.random() * 100) / 255]
var data = '#11111111111100000000000000000000000000111111111111' + 
'#01111111111110000000000000000000000001111111111110' + 
'#00111111111111000000000000000000000011111111111100' + 
'#00011111111111100000000000000000000111111111111000' + 
'#00001111111111110000000000000000001111111111110000' + 
'#00000111111111111000000000000000011111111111100000' + 
'#00000011111111111100000000000000111111111111000000' + 
'#00000001111111111110000000000001111111111110000000' + 
'#00000000111111111111000000000011111111111100000000' + 
'#00000000011111111111100000000111111111111000000000' + 
'#00000000001111111111110000001111111111110000000000' + 
'#00000000000111111111111000011111111111100000000000' + 
'#00000000000011111111111100111111111111000000000000' + 
